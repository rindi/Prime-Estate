		...
		for ($i = $start; $i < $end; $i++) {
			...
			<div class="panel panel-default" style="padding: 10px;">
				...
				<div class="col-md-7">
				    ...
				    <a class="btn btn-default" href="listing_page.php?id=<?php echo $houseval; ?>">View House <span class="glyphicon glyphicon-chevron-right"></span></a>
				    <a class="btn btn-default" href="#">Contact Seller<span class="glyphicon glyphicon-chevron-right"></span></a>
				</div>
			    </div>
			</div>
			</div>
