    ...
    <div class="container">
        ...
        <?php
            ...
            if ($page > 1 && $page < $max) {
                $page = $page + 1;
                $last = $page - 2;
                echo "<li><a href='http://sfsuswe.com/~f14g03/views/search_results.php?search=" . $value . "&page=" . $last . "'>Previous 5 Records</a></li>";
                echo "<li><a href='http://sfsuswe.com/~f14g03/views/search_results.php?search=" . $value . "&page=" . $page . "'>Next 5 Records</a></li>";
            } else if ($page == 1) {
                $page = $page + 1;
