        ...
        <div class="container-fluid">
            <div id="box" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2" >
                ...
                <ol>
                    ...
                    <li>Parking</li>
                    <ul><li>Parking is a big issue which has been troubled by modern families.</li>
                        <li>Home buyers should check how easy the street parking is.</li>
                        <li>Parking is exclusive or shared.</li>
                        <li>Home buyers need to figure how much a parking spot costs if they need.</li>
                    </ul><br/>            </ol>
